...
$run_inparanoid = 1;
$use_bootstrap = {PY_use_bootstrap};# Use bootstrapping to estimate the confidence of orthologs#
                   # Needs additional programs 'seqstat.jar' and 'blast2faa.pl'
$use_outgroup = {PY_use_outgroup}; # Use proteins from the third genome as an outgroup        #
...
$blastall = "{PY_blastall}";  #Add -aN to use N processors
$formatdb = "{PY_formatdb}";
$seqstat = "{PY_seqstat}";
$blastParser = "{PY_blastParser}";
use Time::Piece;
$date = localtime->strftime('%m/%d/%Y')\n;


#$matrix = "BLOSUM62"; # Reasonable default for comparison of eukaryotes.
$matrix = "{PY_matrix}"; #(for prokaryotes),
...
$score_cutoff = {PY_score_cutoff};    # In bits. Any match below this is ignored             #
$outgroup_cutoff = {PY_outgroup_cutoff}; # In bits. Outgroup sequence hit must be this many bits#
                       # stronger to reject best-best hit between A and B     #
$conf_cutoff = {PY_conf_cutoff};   # Include in-paralogs with this confidence or better   #
$group_overlap_cutoff = {PY_group_overlap_cutoff}; # Merge groups if ortholog in one group has more #
                             # than this confidence in other group            #
$grey_zone = {PY_grey_zone};  # This many bits signifies the difference between 2 scores   #
...
my $seq_overlap_cutoff = {PY_seq_overlap_cutoff}; 		# Match area should cover at least this much of longer sequence. Match area is defined as area from start of
					# first segment to end of last segment, i.e segments 1-10 and 90-100 gives a match length of 100.
