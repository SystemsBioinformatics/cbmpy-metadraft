...
def build_bigg2():
    ...
    libSet = 'bigg2'
    models = [bar, clos, eco, bsub, sty, sce, psd, geo, kle, hpy, saur, shig, scer]
    #models = [eco]
    return libSet, models, True


#mus = ('mus', 'iMM1415-(GCF_000001635.25).gbff', 'iMM1415.xml') # garbage gene labels
...
if __name__ == '__main__':
    ...
    build_all = [build_bigg1(), build_bigg2(), build_lab()]
