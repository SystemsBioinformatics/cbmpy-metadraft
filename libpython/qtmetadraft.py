...
class MetaDraftGUI(QWidget):
    ...
    metadraft_rpt_footer = '<p><small>Generated by MetaDraft {} &copy; <a href="https://systemsbioinformatics.github.io/cbmpy-metadraft/">MetaDraft</a>.</small></p>'.format(
        metadraft_version
    )
...
'metadraft_db_version: 2019-1'.",
    ...
    def bp_loadResult(self):
        ...
        self.widget_busy.show()
        self.widgetBusyUpdate(10)
        self._colourCycler_ = itertools.cycle(self._colour_pallet_)
        self.widgetBusyUpdate(50)
    ...
    def buildHtmlStringsReaction(self, reac):
        ...
        bkg_clr_prd = rgb2hex(self._colour_pallet_[-20])
    ...
    def buildHtmlStringsMetab(self, metab):
        ...
        r_html += "<tr><td bgcolor=\"{}\"><strong>{}</strong></td><td bgcolor=\"{}\"><strong>{}</strong></td></tr>".format(
            bkg_clr, 'Id', bkg_clr, S.getId()
        )
        r_html += "<tr><td bgcolor=\"{}\"><strong>{}</strong></td><td bgcolor=\"{}\"><strong>{}</strong></td></tr>".format(
            bkg_clr, 'Name', bkg_clr, S.getName()
        )
